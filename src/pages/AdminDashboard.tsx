...
const AdminCustomers = ({ users }: { users: User[] }) => (
    <div className="space-y-6">
        <div className="flex justify-between items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {users.map((user) => (
                <div key={user.id} className="bg-white/5 backdrop-blur-md p-6 rounded-2xl border border-white/10 shadow-lg flex items-center gap-4 hover:bg-white/10 transition-colors">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-brand-cyan/20 to-blue-600/20 flex items-center justify-center text-brand-cyan font-bold border border-white/5 uppercase">
                    ...
                    <div className="ml-auto">
                        <Button variant="ghost" size="sm" className="text-slate-400 hover:text-white"><MoreHorizontal size={16} /></Button>
                    </div>
                </div>
            ))}
        </div>
    ...
    return (
        <div className="w-full">
            ...
            >
                ...
                {activeTab === 'customers' && <AdminCustomers users={users} />}
